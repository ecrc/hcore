...
/**
 * This program tests HCORE_dsyrk(). The following steps are performed:
 *
 ...
 * 6. Perform tlrC = 1.0 C - 1.0 (AU AV^T) (AU AV^T)^T using HCORE_dsyrk()
...
int main(){
	...
	flop_counter flops;
	HCORE_dsyrk(uplo, trans, nrows, rank, alpha, _AU, ld_AU, _AV, ld_AV,
